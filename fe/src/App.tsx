  ...
  return (
    ...
    >
      ...
      <div className="max-w-[680px] w-full mx-auto px-4 sm:px-6 py-8 relative">
        ...
        >
          {/* Steam logo */}
          <svg className="mx-auto mb-6 w-12 h-12 text-white/80" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          ...
          <p className="text-white/40 text-[15px] max-w-sm mx-auto leading-relaxed">
            An AI agent that searches the entire Steam catalog to find exactly what you're looking for.
          </p>
        </motion.div>
